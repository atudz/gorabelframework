...
class MakeAccessCheck extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:accesscheck
    						{name : The class name}';
     ...
     * @var string
     */
    protected $description = 'Create a new AccessCheck Class.';

    /**
     * The template name
     */
    protected $templateName = 'AccessCheck.stub';
    ...
    /**
     * The AccessCheck class suffix
     */
    protected $suffix = 'AccessCheck';
    
    /**
     * The AccessCheck class file extenstion
     */
    protected $ext = '.php';
