...
Form::macro('datepicker', function($type, $name, $label, $value=null, $attributes=[], $more_class='', $removeIcon = false) {
	
	$addbackground = ($removeIcon == true ? 'datepicker-icon' : '');

	$class = 'form-control '.$more_class.' '.$addbackground;
	...
	$html = '
			<div class="form-group">
				...
				<div class="input-group">
					...
					if(!$removeIcon){
						$html .= '<span class="input-group-addon calendar-click"><i class="fa fa-calendar"></i></span>';
					}
  		$html .= '</div>
	  		</div>';
